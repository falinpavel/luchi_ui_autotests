...
@allure_high_level_marks(epic="Каталог", feature="Подбор страхования")
class TestSelectInsurance:

    @pytest.mark.ui
    @allure_mid_level_marks(story="Пользователь при клике на 'Подобрать страховку' попадает на страницу каталога", testcase_id="Luchi-UI-001",
